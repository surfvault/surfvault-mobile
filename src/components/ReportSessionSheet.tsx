...
// Keep values in sync with REPORT_REASONS in surfvault-api/services/surf/handler.ts
export const REPORT_REASONS: ReportReason[] = [
  ...
  { value: 'privacy', label: 'Privacy — unauthorized photos of me' },
    ...
    >
      <SafeAreaView style={[s.flex, { backgroundColor: isDark ? '#0b1120' : '#ffffff' }]} edges={['top']}>
        ...
        <View style={s.header}>
          ...
          <Text style={[s.headerTitle, { color: isDark ? '#fff' : '#111827' }]}>Report Session</Text>
          <Pressable
