...
interface HomeSkeletonProps {
  /**
   * Show the "Nearby Surf Breaks" + "Nearby Photographers" rows above the
   * feed-card skeleton. Only Discover surfaces those rails for real, so
   * Following/Favorites/Boardroom should pass `false` to avoid teasing
   * content that won't appear.
   */
  showNearby?: boolean;
}

export default function HomeSkeleton({ showNearby = true }: HomeSkeletonProps) {
