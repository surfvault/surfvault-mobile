    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={handleClose}>
      <SafeAreaView style={[s.flex, { backgroundColor: isDark ? '#0b1120' : '#ffffff' }]} edges={['top']}>
        <View style={s.header}>
          ...
          <Text style={[s.headerTitle, { color: isDark ? '#fff' : '#111827' }]}>Report Message</Text>
          ...
          >
            <View style={{ paddingHorizontal: 20, paddingTop: 8, paddingBottom: 16 }}>
              <Text style={[s.intro, { color: isDark ? '#9ca3af' : '#6b7280' }]}>
                Help us understand what's wrong with this message. Reports are anonymous to the
                sender — our team will review and take action as needed.
              </Text>
            </View>
                ...
                return (
                  <Pressable
                    ...
                    style={{
                      ...
                      paddingHorizontal: 12, paddingVertical: 14, borderRadius: 12, marginBottom: 6,
                      backgroundColor: isSelected ? (isDark ? 'rgba(239,68,68,0.12)' : '#fef2f2') : 'transparent',
                    }}
                  >
                    <View style={{
                      ...
                      {isSelected && <View style={{ width: 10, height: 10, borderRadius: 5, backgroundColor: '#ef4444' }} />}
                    </View>
